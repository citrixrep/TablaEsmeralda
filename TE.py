...
def commandHandler(command):
	...
	if command == "help":
		...
		helpPrint("EXIT", "Shut down TE", "exit")
		print()
		...
		if inModule:
			...
			for option in moduleExtendCommands:
				...
				if option[0] == command or command.startswith(option[0]):
					try: 
						updateModule = getattr(currentModuleFile, "setOptions")
...
TE command line interface 
      ...
      ______                                     __     __      
     / ____/_____ ____ ___   ___   _____ ____ _ / /____/ /____ _
    / __/  / ___// __ `__ \ / _ \ / ___// __ `// // __  // __ `/
   / /___ (__  )/ / / / / //  __// /   / /_/ // // /_/ // /_/ / 
  /_____//____//_/ /_/ /_/ \___//_/    \__,_//_/ \__,_/ \__,_/  
                                                                

"""

print(GREEN + header + "v1.0\n" + END)
...
parser = argparse.ArgumentParser(description="TE")
...
while True:
	if inModule:
		inputHeader = BLUE + "TE" + RED + "/" + currentModule + BLUE + " $> " + END
	else:
		inputHeader = BLUE + "TE $> " + END
